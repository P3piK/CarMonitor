...
namespace CarMonitor.Host
{
    class Program
    {
        ...
        private const string CONSUMPTION_SERVICE_SUFFIX = "/ConsumptionService";
        ...
        private static void RunHost()
        {
            ...
            Uri consumptionAddress = new Uri(String.Concat(BASE_PATH, CONSUMPTION_SERVICE_SUFFIX));
            ...
            using (ServiceHost consumptionHost = new ServiceHost(typeof(ConsumptionService)))   //, consumptionAddress))
            {
                ...
                //consumptionHost.Description.Behaviors.Add(smb);
                ...
                // by the service.
                profileHost.Open();
                consumptionHost.Open();

                Console.WriteLine("The service is ready at {0}", profileAddress);
                Console.WriteLine("The service is ready at {0}", consumptionAddress);
                Console.WriteLine("Press <Enter> to stop the service.");
                Console.ReadLine();

                // Close the ServiceHost.
                profileHost.Close();
                consumptionHost.Close();
            }
        }
    }
}
